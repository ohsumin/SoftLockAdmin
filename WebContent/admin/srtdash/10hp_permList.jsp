...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">가입 허가된 병원 리스트입니다</h4>
            ...
            <!-- page title area end -->
            <div class="main-content-inner" style="width: 60%; margin-left:200px;" >
                <!-- 메인내용s -->
                <br /><br /><br /><br />
                  <!-- table primary start -->
                  <div class="col-lg-6 mt-5">
                      <div class="card" style="width: 1000px; "> 
                          <div class="card-body">
                              <h4 class="header-title">허가병원 리스트</h4>
                              <div class="single-table">
                                  <div class="table-responsive" style="overflow-y: hidden; overflow-x: hidden;">
                                   <form action="ReqList.do" method="get">
                                   <div class="row">
								  <div class="form-group col-sm-3">
								  	<input name="search"  class="form-control" type="text" id="search" placeholder="ID로검색">
								  </div>
								  <input type="hidden" id="page" name="page" value="1"/>
								  <div class="col-sm-4">
								  	<button type="submit" class="btn btn-warning" style="margin-right:10px;">검색하기</button>
								  	<input type="button" class="btn btn-secondary" value="전체보기" onclick="location.href='ReqList.do?page=1'"/>
								  </div>
								</div>
                           </form>
                                 ...
                                 <c:forEach items="${lists }" var="row" varStatus="loop">
                                              <tr>
                                                  ...
                                                  <td>
	                                                  <form action="Del.do?" onclick="return isDelete(this);">
			                                             <input type="hidden" id="id" name="id" value="${row.hp_id }"/>
			                                             <input type="hidden" id="page" name="page" value="1" />
			                                             <i class="ti-trash" onclick="this.submit();"></i>
			                                          </form>
                                          		</td>                                                  
                                              </tr>  
                                              </c:forEach>
